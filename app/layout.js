...
export const metadata = {
  metadataBase: new URL('https://theesmasports.com'),
  title: {
  ...
  icons: {
    icon: [
      { url: '/img/ogimage.png', type: 'image/png' },
    ],
    shortcut: '/img/ogimage.png',
    apple: '/img/ogimage.png',
  },
  openGraph: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Theesma Sports | Elite Arsenal",
      },
    ],
    locale: "en_IN",
    type: "website",
  ...
  twitter: {
    ...
    images: ["/img/ogimage.png"],
    creator: "@TheesmaSports",
  },
  robots: {
    index: true,
    follow: true,
  ...
  alternates: {
    canonical: 'https://theesmasports.com',
  },
};
